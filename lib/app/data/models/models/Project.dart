...
List<AppInfo> apps = [
  ...
  AppInfo(
    ...
    namImg: '$urlBase/154527798-9086444e-fc8b-4828-9c03-a87de7869ba5.png',
    description:
  ...
  AppInfo(
    ...
    description: "App Móvil y Web para gestionar las citas de una Clínica Médica. Cuenta con los siguientes roles: " +
        "ADMINISTRADOR, DOCTOR, TECNICOS, SECRETARIA, PACIENTE, cada uno bien definido. La app cuenta con validadción de " +
        "número de teléfono por OTP con Firebase, notificaciones Push con FCM de Firebase. Tiene un Dashboard administrativo, " +
        "donde se puede: CAMBIAR DATOS DE LA EMPRESA (NOMBRE, DIRECCION, TELEFONOS, ETC), CAMBIAR LOGO, CREACION DE USUARIOS, " +
